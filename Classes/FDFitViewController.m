...
@implementation FDFitViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    ...
    if (self) {
		...
		self.title = NSLocalizedString(@"常用快递",@"");
...
- (NSFetchedResultsController *)fetchedResultsController {
	...
	{
		NSPredicate* predicate = [NSPredicate predicateWithFormat:@"isHidden == NO && isUsually = YES"];
